...
<editar class="flex justify-center align-middle mt-4">
    <div class="h-96 w-3/4 bg-green-100 border-solid border-2 border-gray-700 rounded-md flex justify-between items-center">
      ...
      <div class="h-60 w-60 rounded-full text-right">
        ...
        <input class="text-xl text-green-400 w-52 rounded-md p-1" value="Juan Antonio Montoya Ramirez"></input>

        <div class="text-2xl text-green-800">Departamento</div>
        <input class="text-xl text-green-400 w-52 rounded-md p-1" value="Auxiliar de Servicios"></input>
      ...
      <div class="h-60 w-60 rounded-full flex flex-col">
        ...
        <button onclick="GuardarA()" class="bg-green-300 py-3 px-4 rounded-lg mt-5 hover:bg-green-500 hover:text-gray-100">
          Guardar Cambios
        </button>
      ...
      <div class="h-60 w-60 rounded-lg text-left">
        ...
        <input class="text-xl text-green-400 w-40 rounded-md p-1" value="jamr.as@mc.com"></input>
        
        <div class="text-2xl text-green-800">Número:</div>
        <input class="text-xl text-green-400 w-40 rounded-md p-1" value="442-567-7867"></input>
