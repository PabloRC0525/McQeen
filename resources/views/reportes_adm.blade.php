...
<reportes class="flex justify-center align-middle my-5 ">
    ...
    <div class="h-96 w-3/4 bg-red-100 border-solid border-2 border-gray-700 mx-2 rounded-md flex">

        <div class="w-full bg-gray-100 my-4 mr-4 rounded-lg border-solid border-2 border-gray-500 flex-col">
            <div class="bg-red-500 p-2 rounded-md items-center">
            ...
            <div class="w-full h-8 px-2 rounded-md mt-3 flex">
                ...
                <select class="m-2 w-1/6 h-10 bg-red-500 border-2 border-gray-600 rounded-md text-center" name="Filtrar">
                  <option value="Estatus">Estatus</option>
                  <option value="Fecha" selected>Fecha</option>
                  <option value="Departamento">Departamento</option>
                </select>
                
                <button class="m-2 w-1/6 h-10 bg-red-500 border-2 border-gray-600 rounded-md text-center ">
                  Consultar
                </button>
            
        </div>
        <table class="table-auto border-collapse mx-4 mt-8 w-11/12 ">
          <thead>
              <tr class="bg-red-300 text-red-600 uppercase text-sm leading-normal">
          ...
          <tbody class="text-red-600 text-sm font-light">
