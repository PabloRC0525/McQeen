...
<perfil class="flex justify-center align-middle">
  ...
  <div class="h-96 w-3/4 bg-blue-100 border-solid border-2 border-gray-700 rounded-md flex justify-between items-center">
      ...
      <div class="h-60 w-60 rounded-full text-right">
        ...
        <div class="text-xl text-blue-400">Pablo Enrique Ramírez Carrillo</div>

        <div class="text-2xl text-blue-800">Departamento</div>
        <div class="text-xl text-blue-400">Auxiliar de Servicios</div>
      ...
      <div class="h-60 w-60 rounded-full flex flex-col">
        ...
        <button onclick="EditarC()" class="bg-blue-300 py-3 px-4 rounded-lg mt-5 hover:bg-blue-500 hover:text-gray-100">
          Editar
        </button>
        <script>
          function EditarC() {
      ...
      <div class="h-60 w-60 rounded-lg text-left">
        ...
        <div class="text-xl pb-6 text-blue-400">pablo@example.com</div>

          <div class="text-2xl text-blue-800">Número:</div>
          <div class="text-xl text-blue-400">441-116-6013</div>
